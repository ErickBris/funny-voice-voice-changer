 ...
 *
 */
public class DBShimmerFrameLayout extends FrameLayout {
  ...
  public DBShimmerFrameLayout(Context context) {
    this(context, null, 0);
  }

  public DBShimmerFrameLayout(Context context, AttributeSet attrs) {
    this(context, attrs, 0);
  }

  public DBShimmerFrameLayout(Context context, AttributeSet attrs, int defStyle) {
